...
solution "VDrift"
	...
	configuration {"macosx"}
		...
		files {"vdrift-mac/config_mac.mm", "vdrift-mac/SDLMain.h", "vdrift-mac/SDLMain.m", "vdrift-mac/Info.plist", "vdrift-mac/Readme.rtf", "vdrift-mac/vdrift.icns"} --Add mac specfic files to project.
