...
class DATAMETRIC
{
	...
	protected:
		...
		std::map< std::string, DATALOG::log_column_T const* > input_data_columns; //!< pointers to input data columns
...
class TYPEDMETRICFACTORY
{
	...
	private:
		static metric_map_T * metric_types; //!< map of metric-type names to functors for creating a metric object of named type
};
...
class DATAMANAGER
{
	public:
		...
		/** Write the data log and delete all the metrics */
		void Clear();
