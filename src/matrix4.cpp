...
QT_TEST(matrix4_test)
{
	...
	MATHVECTOR <float, 3> in;
	mat.TransformVectorOut(in[0], in[1], in[2]);
	
	QT_CHECK_CLOSE(out[0], orig[0], 0.001);
	QT_CHECK_CLOSE(out[1], orig[1], 0.001);
	QT_CHECK_CLOSE(out[2], orig[2], 0.001);
}
